...
standart_codes = {'c': '0000', 'p': '0001', 'z': '0010', 'j': '0011', 'h': '0100', 'f': '01010', 'y': '01011',
...
def Shennon(symbols, count):
    return sum([(symbols[i] / count) * log2(count / symbols[i]) for i in symbols])
...
print(-Shennon(symbols, len(symbols)), 'Ожидаемое количество информации по формуле Шеннона')